...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('receive_money')); ?>:</b>
	<?php echo CHtml::encode($data->receive_money); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('is_before')); ?>:</b>
	<?php echo CHtml::encode($data->is_before); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('manage_by')); ?>:</b>
	<?php echo CHtml::encode($data->manage_by); ?>
	<br />
