                                        ...
                                        'widgetOptions'      => array(
                                            'editorOptions' => array(
                                                ...
                                                'toolbar'              => array(
                                                    ...
                                                    array(
                                                        'Format', 'Image', 'Flash', 'Table', 'Smiley', 'SpecialChar', '-',
                                                        'TextColor', 'BGColor', '-',
                                                        'Undo', 'Redo', '-',
                                                        'Maximize'
                                                    ),
                                    ...
                                    <div class="" style="padding: 10px">
                                        <div class="avatar-view" title="">
                                            ...
                                            if (isset($model->thumbnail) && $model->thumbnail != '') {
                                                ...
                                                $thumb_url = '../themes/default/images/upload-icon.jpg';
                                            }
...
<div class="modal-body">
    ...
    <script>
        jwplayer.key = "ekOj7z6QgNVVyJrzCEIIJDRRUIO9zxJkB4eHAQ==";
    </script>
...
<script language="javascript">
    ...
    -->
    $('#modal_preview_video').on('hidden.bs.modal',
    function
    ()
    {
    $("#modal_preview_video
