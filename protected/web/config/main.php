    ...
    'components'        => array(
        ...
        'urlManager'   => array(
            ...
            'rules'          => array(
                ...
                'chinh-sach-ban-hang'           => 'site/salesPolicy',
                'chinh-sach-bao-mat'            => 'site/privacyPolicy',
                'tin-tuc'            => 'site/news',
                'an-pham'            => 'site/publications',
                'an-pham/<id:\d+>'   => 'site/publicationsDetail',
                'dao-tao'            => 'site/educate',
                'tuong-tac'           => 'site/interactive',
                'khoa-hoc'            => 'site/course',
                'dang-ky-khoa-hoc/<course_id:\d+>' => 'site/courseRegister',
                'hoi-dap-phap-luat'   => 'site/faq',
                'tim-hieu-phap-luat'   => 'survey/index',
