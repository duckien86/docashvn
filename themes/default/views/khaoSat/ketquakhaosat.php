...
<div class="x_panel">
    <div class="x_title">
        ...
        <div class="clearfix" >
            <h2>Kết quả khảo sát</h2><small></small>
        </div>
    </div>
...
<div class="x_panel">
    <div class="x_content">
        <form method="post" action="uploadExcel" enctype="multipart/form-data" id="uploadForm">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    foreach ($dapans as $dapan) {
                       ...
                       ?>
                        <div class="radio">
                            <label>
                                <input type="radio" value="option1" id="optionsRadios1" name="optionsRadios"> <?php echo $dapan;?>
                            </label>
                        </div>
                       <?php
