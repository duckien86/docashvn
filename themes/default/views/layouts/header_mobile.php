        ...
        ?>
                <li class="">
                        ...
                        <ul>
                            ...
                            ?>
                                <li>
                                        ...
                                        <ul>
                                            ...
                                            ?>
                                                <li>
                                                    <?php if ($sub_menu_5) : ?>
                                                        ...
                                                        <ul>
                                                            <?php foreach ($sub_menu_5 as $level_5) : ?>
                                                                <li>
                                                                    <a href="<?= Yii::app()->controller->createUrl('products/index', array('id' => $level_5->id)); ?>" title="" class="level-3">
                                                    ...
                                                    <?php else : ?>
                                                        <!--nosub-->
                                                        <a href="<?= Yii::app()->controller->createUrl('products/index', array('id' => $level_4->id)); ?>" title="">
                                                            <span class="level-3"><?= CHtml::encode($level_4->name); ?></span>
                                                        </a>
                                                    <?php endif; ?>
                                                </li>
                                    ...
                                    <?php else : ?>
                                        <!--nosub-->
                                        <a href="<?= Yii::app()->controller->createUrl('products/index', array('id' => $level_3->id)); ?>" title="">
                                            <span class="level-2"><?= CHtml::encode($level_3->name); ?></span>
                                        </a>
                                    <?php endif; ?>
                                </li>
                    ...
                    <?php else : ?>
                        <!--nosub-->
                        <span class="level-1">
                            <a href="<?= Yii::app()->controller->createUrl('products/index', array('id' => $level_2->id)); ?>" title="">
                                <?php if ($index != 1) : ?>
                                    <div class="space_5"></div>
                                <?php endif; ?>
                                <span><?= CHtml::encode($level_2->name); ?></span>
...
<nav id="menu_right">
    <ul>
        ...
        <li>
            <a href="<?= Yii::app()->controller->createUrl('site/about'); ?>" title="" class="level-1"><span><?= Yii::t('web/full_home', 'about'); ?></span></a>
        </li>
        <li>
            <a href="<?= Yii::app()->controller->createUrl('site/agency'); ?>" title="" class="level-1"><span><?= Yii::t('web/full_home', 'agency'); ?></span></a>
        </li>
        <li>
            <a href="<?= Yii::app()->controller->createUrl('site/contact'); ?>" title="" class="level-1"><span><?= Yii::t('web/full_home', 'contact'); ?></span></a>
        </li>
    </ul>
</nav>
